...
class Packer {
  constructor(options = {}) {
    ...
    normalizedOptions.deflateFactory =
      normalizedOptions.deflateFactory || zlib.createDeflate;
    normalizedOptions.bitDepth = normalizedOptions.bitDepth || 8;
    normalizedOptions.fastFilter = normalizedOptions.fastFilter === true;
  ...
  _packChunk(type, data) {
    ...
    buf.writeUInt32BE(
      zlib.crc32(buf.subarray(4, buf.length - 4)),
      buf.length - 4,
    );
    return buf;
  }
